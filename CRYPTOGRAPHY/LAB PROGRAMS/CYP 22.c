...
int main() {
    ...
    printf("Ciphertext 1: "); print8(ciphertext[0]); printf("\n");
    printf("Ciphertext 2: "); print8(ciphertext[1]); printf("\n");
    printf("Decrypted 1:  "); print8(decrypted[0]); printf("\n");
    printf("Decrypted 2:  "); print8(decrypted[1]); printf("\n");
